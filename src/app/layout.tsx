...
export const metadata: Metadata = {
  title: "MyTrendyPhone - Mobilcovers, opladere og tilbehør",
  description:
    "Danmarks største udvalg af mobilcovers, skærmskånere, opladere og tilbehør. Nem 30-dages returret.",
};
        ...
        <body style={{ margin: 0, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", background: "#fff" }}>
          <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem", textAlign: "center" }}>
            ...
            <p style={{ color: "#6b7280", fontSize: "0.9rem", maxWidth: "360px", lineHeight: 1.6, margin: 0 }}>
              Siden er midlertidigt utilgængelig. Prøv igen senere eller kontakt os direkte.
            </p>
          </div>
        </body>
      </html>
